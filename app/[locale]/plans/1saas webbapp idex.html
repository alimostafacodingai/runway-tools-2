      ...
      <main className="min-h-screen bg-black text-white px-6 py-16 flex flex-col items-center">
        ...
        <div className="mx-auto grid max-w-6xl gap-8 md:grid-cols-3">
          ...
          <div className="border border-white/20 rounded-2xl p-8 bg-zinc-900 w-full">
            <h3 className="text-2xl font-semibold mb-2">🧢 Free Plan — 0 EGP</h3>
            ...
            <ul className="list-disc list-inside space-y-2 text-sm text-white/80 mb-6">
              ...
              <li>Chat with the AI for <strong>quick answers</strong></li>
            </ul>
          ...
          <div className="border border-yellow-400/40 rounded-2xl p-8 bg-zinc-900 w-full shadow-[0_0_25px_rgba(255,255,0,0.15)]">
            <h3 className="text-2xl font-semibold mb-2">💼 Beginner Plan — 250 EGP</h3>
            <p className="text-white/70 mb-6">
              Perfect for: Small Egyptian brands (selling 10–50 pcs / month) ready
              to manage operations professionally.
            </p>
  
            <h4 className="text-lg font-semibold mb-3">Includes everything in Free, plus:</h4>
            <ul className="list-disc list-inside space-y-2 text-sm text-white/80 mb-6">
            ...
            <a
              href="https://whop.com/checkout/plan_OrrN2KQk5OKnY?d2c=true"
              className="block text-center bg-yellow-400 text-black py-3 rounded-lg font-semibold hover:bg-yellow-300 transition"
            >
              Get Beginner Plan
            </a>
          </div>
          ...
          <div className="border border-purple-400/40 rounded-2xl p-8 bg-zinc-900 w-full shadow-[0_0_25px_rgba(168,85,247,0.15)]">
            <h3 className="text-2xl font-semibold mb-2">👑 Pro Plan — 300 EGP</h3>
            <p className="text-white/70 mb-6">
              Perfect for: Founders scaling up or running serious drops (50–200 pcs / month).
            </p>
  
            <h4 className="text-lg font-semibold mb-3">Includes everything in Free + Beginner, plus:</h4>
            <ul className="list-disc list-inside space-y-2 text-sm text-white/80 mb-6">
              <li>✅ Full AI Fashion Mentor (Advanced)</li>
              <li>Unlimited chat</li>
              <li>Full prompt library (100+ prompts)</li>
              <li>✅ All Contacts Unlocked</li>
              <li>Manufacturers (Egypt & regional)</li>
              <li>Packaging & label suppliers</li>
              <li>Shipping companies contacts</li>
              <li>Freelance designers & tech-pack pros</li>
              <li>Printing & embroidery contacts</li>
              <li>✅ AI Prompt PDF Library (Egypt Edition)</li>
            </ul>
  
            <a
              href="https://whop.com/checkout/plan_ni4U7dhxJpJPk?d2c=true"
              className="block text-center bg-purple-500 text-white py-3 rounded-lg font-semibold hover:bg-purple-400 transition"
            >
              Get Pro Plan
            </a>
          </div>
