...
export default function ProductionPlannerPage() {
  const t = useTranslations("productionPlannerPage");
  ...
  useEffect(() => {
    ...
    function compute() {
      ...
      setText(
        "budgetUsageOut",
        budget > 0 ? t("results.budgetUsage", { pct: budgetUsagePct.toFixed(1) }) : t("results.noBudget")
      );
    ...
    <div className="prod-root">
      ...
      <div className="grid">
        ...
        <div className="card">
          ...
          <div className="explain">
            <p>
              <strong>{t("driver.title")}</strong>
            </p>
            <p id="driverOut">{t("driver.demand")}</p>
